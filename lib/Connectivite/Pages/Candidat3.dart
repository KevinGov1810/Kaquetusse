...
class Candidat3Screen extends StatefulWidget {
  final Function(int) onChangedStep;
  Candidat3Screen({Key? key, required this.onChangedStep}) : super(key: key);

  @override
  _Candidat3ScreenState createState() => _Candidat3ScreenState();
}

class _Candidat3ScreenState extends State<Candidat3Screen> {
  @override
...
class Candidat_images extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    AssetImage assetImage = AssetImage('images/Alexandre.png');
