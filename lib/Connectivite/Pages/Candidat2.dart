...
class Candidat2Screen extends StatefulWidget {
  final Function(int) onChangedStep;
  Candidat2Screen({Key? key, required this.onChangedStep}) : super(key: key);

  @override
  _Candidat2ScreenState createState() => _Candidat2ScreenState();
}

class _Candidat2ScreenState extends State<Candidat2Screen> {
  @override
...
class Candidat_images extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    AssetImage assetImage = AssetImage('images/candidat.png');
