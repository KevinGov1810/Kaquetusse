...
class Candidat4Screen extends StatefulWidget {
  final Function(int) onChangedStep;
  Candidat4Screen({Key? key, required this.onChangedStep}) : super(key: key);

  @override
  _Candidat4ScreenState createState() => _Candidat4ScreenState();
}

class _Candidat4ScreenState extends State<Candidat4Screen> {
  @override
...
class Candidat_images extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    AssetImage assetImage = AssetImage('images/Victor.png');
