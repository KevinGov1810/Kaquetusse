...
class CandidatScreen extends StatefulWidget {
  ...
  CandidatScreen({Key? key, required this.onChangedStep}) : super(key: key);

  @override
  _CandidatScreenState createState() => _CandidatScreenState();
}
...
class Candidat_images extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    AssetImage assetImage = AssetImage('images/Youssef.png');
